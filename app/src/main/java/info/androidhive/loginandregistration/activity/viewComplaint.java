...
public class viewComplaint extends Activity implements AsyncResponse
...
HashMap<String,String> a1 = new HashMap<>();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            if ("Admin".equals(MainActivity.username)||"Water".equalsIgnoreCase(MainActivity.username)||"gasleak".equalsIgnoreCase(MainActivity.username)||"Water".equals(MainActivity.username) || "Garabage".equals(MainActivity.username)|| "Parking".equals(MainActivity.username)|| "Electricity".equals(MainActivity.username)|| "Sound".equals(MainActivity.username)|| "Others".equals(MainActivity.username)) {

                sendList.put("action", "getlistNotImp");
            }
            else{
                    sendList.put("action", "getlistUser");
